...
class EmotionShield:
    ...
    Parameters:
        ...
        embedder: EmbeddingEngine instance for semantic gaslighting detection.
                  If None, one is lazily created from cognitio.embeddings.
    """
    ...
    def __init__(self, config: Optional[dict] = None, embedder=None) -> None:
        ...
        self._session_emotion_history: list[float] = []
    ...
    def _ensure_embedder(self) -> None:
        ...
        if self._embedder is None:
            try:
                ...
                logger.warning("EmotionShield: embedder unavailable, gaslighting detection disabled: %s", e)
                return
    ...
    def evaluate(
        ...
        contextual_score = self._contextual_validation(raw_emotional_intensity, conversation_context)
    ...
    def _update_history(self, intensity: float) -> None:
        ...
        if len(self._session_emotion_history) > 20:
            self._session_emotion_history.pop(0)
